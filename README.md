...
This is an introductory Flutter application for every new developer that will make it easy for
you to understand Infinum's Flutter architecture for each project. Dasher App will introduce you to
...
Dasher app uses the architecture structure described in [this](https://drive.google.com/file/d/1QIApooLL0nNg39l0FON3FhyAz6yI9Hau/view)
video. Below is the architecture tree:
